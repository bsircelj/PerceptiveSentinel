...
for method in methods:
    ...
    for train_index, test_index in kf.split(X):
        ...
        #if hasattr(learner, 'export_json'):
        #    learner.export_json(f'{method["name"]}.json')
        #    learner.import_json(f'{method["name"]}.json')
        learner.fit(X_train, y_train)
        #if hasattr(learner, 'export_json'):
        #    learner.export_json(f'{method["name"]}.json')
        #    json_props = learner.import_json(f'{method["name"]}.json')
        #    print(json.loads(json_props))
