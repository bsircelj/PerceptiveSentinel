...
class EdgeExtractionTask(EOTask):
    ...
    def __init__(self,
        ...
        """
        :param features: A list of feature names from which the edges are computed.
            All the features need to be of type FeatureType.Data
